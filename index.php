			...
			<div class="col-md-2"><!--  Área de login ou inscrição do aluno -->
				...
				<h4 class="text-light p-2 ms-4">Área do Aluno</h4>
					...
					<?php if(isset($_GET['signin'])){
						 ?>
						<div class="row">
							<div class="p-2 ms-4 alert alert-danger" id="signupErrorMessage">
							</div>
						</div>
						<script type="text/javascript">
    							var text = <?php echo json_encode($_GET['signin'], JSON_HEX_TAG); ?>;
								loginError(text)
						</script>
					<?php } ?>
				</div>
				...
				<h4 class="text-light p-2 ms-4">Área de Registro</h4>
					...
					<?php if(isset($_GET['signup'])){
						...
						<script type="text/javascript">
    							var text = <?php echo json_encode($_GET['signup'], JSON_HEX_TAG); ?>;
								regError(text)
						</script>
					<?php } ?>
				</div>
