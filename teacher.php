...
<body>
	<div class="container-fluid"> <!-- Container Principal -->
		...
		<div class="row principal"><!-- Área principal -->
			...
			<div class="col-md-10"> <!-- Área do professor -->
				<div class="row">
				...
				<div class="row">
					<h5 class="mt-2">Envio de exercicíos:</h5>
					<form method="post" action="">
						<div class="row">
							<div class="col">
								<label class="form-label" for="aluno">Aluno:</label>
							...
							<div class="col d-flex align-items-end">
							  <label for="arquivos" class="form-label"></label>
					...
					<form method="post" action="">
							<div class="row mb-2">
								...
								<div class="col d-flex align-items-end">
									...
									<button class="btn btn-md"><i class="fas fa-share fa-2x text-success"></i></button>
								</div>
					</form>
			</div>	
		</div>
